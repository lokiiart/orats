...
ENV INSTALL_PATH /orats
# The name of the application is orats and while there
...
# having to CD into the /orats folder every time would be
# lame, so instead we can set the WORKDIR to be /orats.
#
...
# orats/ path inside of the Docker image.
#
# It copies it to /orats because of the WORKDIR being set.
#
...
# /orats folder inside of the Docker image.
#
